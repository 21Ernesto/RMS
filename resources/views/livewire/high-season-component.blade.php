<section>
    <h1 class="text-lg font-bold">Temporada alta</h1>
        ...
        <div class="card-body">
            @foreach ($highSeasons as $highSeason)
                <div class="border-b border-gray-200 mb-2 pb-2">
                    <p class="text-xs">{!! Str::limit($highSeason->description, 100) !!}</p>
                    <button wire:click="edit({{ $highSeason->id }})" title="Editar {{ $highSeason->name }}"
