                    ...
                    <div class="px-5 mb-2">
                        ...
                        <div class="mt-1 flex space-x-4">
                            <div class="flex items-center">
                                <input id="tour" value="tour" wire:model="key" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="tour" class="ml-2 block text-sm font-medium text-gray-700">Tour</label>
                            </div>
                            <div class="flex items-center">
                                <input id="paquetes" value="packages" wire:model="key" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="paquetes" class="ml-2 block text-sm font-medium text-gray-700">Paquetes</label>
                            </div>
                            <div class="flex items-center">
                                <input id="promos" value="promotions" wire:model="key" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="promos" class="ml-2 block text-sm font-medium text-gray-700">Promos 2x1</label>
                            </div>
                            <div class="flex items-center">
                                <input id="paque" value="travelpackages" wire:model="key" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="paque" class="ml-2 block text-sm font-medium text-gray-700">Paque Viajes</label>
                            </div>
                            <div class="flex items-center">
                                <input id="combo" value="friendscombos" wire:model="key" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="combo" class="ml-2 block text-sm font-medium text-gray-700">Combo Amigos</label>
                            </div>
                            <div class="flex items-center">
                                <input id="tren" value="mayantrains" wire:model="key" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                <label for="tren" class="ml-2 block text-sm font-medium text-gray-700">Tren Maya</label>
                            </div>
                        </div>
                        @error('key')
                            <span class="text-red-400 text-xs">{{ $message }}</span>
