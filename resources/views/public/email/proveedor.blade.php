                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff">
                            ...
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                ...
                                <li><strong>Nombre del cliente:</strong> {{ $purchase->name_client }}</li>
                                <li><strong>Correo electrónico del cliente:</strong> {{ $purchase->email }}</li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
