                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff">
                            ...
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                ...
                                <li><strong>Cantidad simple:</strong> {{ $payment->quantity_simple }}</li>
                                <li><strong>Cantidad doble:</strong> {{ $payment->quantity_double }}</li>
                                <li><strong>Cantidad triple:</strong> {{ $payment->quantity_triple }}</li>
                                <li><strong>Cantidad quadruple:</strong> {{ $payment->quantity_quadruple }}</li>
                                <li><strong>Cantidad menos de 10 años:</strong>
                                    {{ $payment->quantity_children_under_10 }}</li>
                                <br><br>
