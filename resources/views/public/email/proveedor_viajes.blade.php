                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff">
                            ...
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                ...
                                <li><strong>Cantidad simple:</strong> {{ $purchase->cantidad_single }}</li>
                                <li><strong>Cantidad doble:</strong> {{ $purchase->cantidad_double }}</li>
                                <li><strong>Cantidad triple:</strong> {{ $purchase->cantidad_triple }}</li>
                                <li><strong>Cantidad quadruple:</strong> {{ $purchase->cantidad_quadruple }}</li>
                                <li><strong>Cantidad menos de 10 años:</strong> {{ $purchase->cantidad_child }}</li>
                                <br><br>
                                <li><strong>Total:</strong> $ {{ $purchase->total_proveedores }} MXN</li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
